...
.btn-box{
	...
	<nav class="navbar navbar-inverse">
				...
				<button class="btn btn-danger dropdown-toggle dropdown btn-box" type="button" data-toggle="dropdown"style="margin-right: 20px">More
    <span class="caret"></span></button>
    <ul class="dropdown-menu">
    <li><a href="new_conection">New connection</a></li>
      <li><a href="temp.php">Show bill</a></li>
      <li><a href="cod_pay.php">Pay bill</a></li>
      <li><a href="bill_report.php">Print bill</a></li>
      <li><a href="meter_reading.php">Logout</a></li>
    
      
    </ul>
					<li><a href="contact.php"><span class="glyphicon glyphicon-phone-alt "style="color:blue"></span> <b>Contact</b></a></li>
      <li><a href="sign_up.php"><span class="glyphicon glyphicon-user"></span><b> Sign Up</b></a></li>
     <li><a href="consumer_login.php"><span class="glyphicon glyphicon-log-in" ></span><b style="padding-right: 20px"> Login</b></a></li>
