...
<html>
	...
	<form method="post" action="" enctype="multipart/form-data">
		<div class="col-sm-4"style="margin-top: -20px">
			<img src="image/zz.jpeg"   width="420" height="2020" class="img-rectangle" >
		</div>
		<div class="col-sm-7">
		...
		<div class="form-group">
				...
				<input type="number"name="unit" class="form-control"value=""></div>
				<div class="form-group">
			...
			<input type="text"name="appl_name" class="form-control"></div>
			<div class="form-group">
				<label class="txt">Father's name :</label>
			<input type="text"name="fhname" class="form-control" ></div>
			<div class="form-group">
			...
			<input type="text"name="occupation" title="please enter your occupation" class="form-control" ></div>
			<div class="form-group">
				<label class="txt">City/Village name :</label>
			<input type="text"name="city" title="please enter your city or village name" class="form-control" ></div>
			<div class="form-group">
			...
			<input type="number"name="num" class="form-control"required title="please enter your 10 digit number" pattern="[0-9]{10,12}"></div>
			<div class="form-group">
				<label for="image" class="txt">Photo :</label>
				<input type="file" accept="image/*" required="" name="img1"class="form-control"placeholder="file not choosen" onchange="loadfile(event)"><br>
				<br>
			...
			<div class="form-group">
				...
				<input type="file"name="img2"class="form-control"placeholder="file not choosen"  accept="image/*" required title="please submit your address proof(eg:PAN card,Aadhar Card)" onchange="loadfile1(event)">
				...
				<input type="text" required="" pattern="{2,}" name="id_mark"class="form-control" title="please enter your address"></div>
...
<tr><td>Connection type</td><td><?php echo $data2[1];?></td></tr>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Modify New Connection</h4>
        </div>
        <div class="modal-body">
          <table class="table tb resposive">
		<table class="table table-bordered tab">
