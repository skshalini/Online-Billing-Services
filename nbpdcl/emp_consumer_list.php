...
<tr  style="background-color: white;"><td colspan="4">
		...
		<font face="stencil" color="white" ><h1 align="center">North Bihar Power distribution Company Limited</h1 > </font>
		
		</div></td></tr>
		<tr style="background-color: #93bb80">
		<td colspan="6">
			<div class="container-fluid "  style="padding-top: ;width:100%">
		<font face="algebrian" color="black" ><h2 align="center">CONSUMER LIST</h2 > </font>
		
		</div>
		</td>
		</tr>
	<tr style="background-color: white;">
		<th>Consumer id</th><th>Name</th><th>Father's Name</th><th>Date-of-Birth</th>
		</tr>
		<?php
